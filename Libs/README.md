...
Unmodified copies of the libraries GoldLedger uses for its minimap button. Each is
...
To update a library, replace its file with the newer release; no GoldLedger code changes are needed unless its API changes.
